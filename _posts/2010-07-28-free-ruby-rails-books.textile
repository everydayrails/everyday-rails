...
Dave Thomas and Andy Hunt, the Pragmatic Programmers themselves, penned the book that is credited with popularizing Ruby in the United States. The first edition (from 2001) is available for free, or you can buy the "second edition, which covers Ruby 1.8":http://pragprog.com/titles/ruby/programming-ruby, or the "third edition, covering Ruby 1.9":http://pragprog.com/titles/ruby3/programming-ruby-1-9, from the Pragmatic Programmers.
