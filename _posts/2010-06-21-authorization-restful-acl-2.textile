...
<div class="box">
  You can also apply these helpers to <code>show.html.haml</code> to hide the Edit and Destroy links from non-administrators.
</div>
