...
By the way, if you're interested in learning more about the internals of this gem, check out Jos&#233;'s "Crafting Rails Applications&#058; Expert Practices for Everyday Rails Development":http://pragprog.com/book/jvrails/crafting-rails-applications (no relation to this blog). It's a great way to get a better understanding of Ruby and Rails internals.
