...
<div class="box">
  Thanks again to those of you who are following <em>Everyday Rails</em> on Twitter or left feedback since I shared a link to the site on "RubyFlow":http://www.rubyflow.com/. New content is coming next week--look for a series on how I do authentication and authorization in Rails apps to begin.
</div>